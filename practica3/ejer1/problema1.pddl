...
(define (problem ej1p)
    ...
    (:init
        ...
        ; VCE
        ; - Indicando que la unidad VCE1 es un VCE.
        (unitType VCE1 VCE)
        ; - Localizando en el mapa el VCE1.
        (in VCE1 LOC11)
    ...
    (:goal
        (and
            ; El objetivo es que VCE1 esté extrayendo un recurso mineral.
            (isExtracting VCE1 mineral)
        )
    )
)